...
Route::middleware(['auth'])->group(function (){
    ...
    Route::post('/ai-chat/send-message', [AiChatController::class, 'sendMessage'])->name('ai.chat.send');
    Route::post('/ai-chat/stream', [AiChatController::class, 'streamMessage'])->name('ai.chat.stream');
    Route::get('/ai-chat/history', [AiChatController::class, 'getHistory'])->name('ai.chat.history');
    Route::post('/ai-chat/save-place', [AiChatController::class, 'savePlaceToTrip'])->name('ai.chat.savePlace');

    // Retornar datas da viagem atualmente selecionada na sessão (se houver)
    Route::get('/trip/current', [ViagensController::class, 'currentTrip'])->name('trip.current');
});
