...
class FormController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $meioLocomocao = $request->input('meio_locomocao');
            $usaCarroProprio = $meioLocomocao === 'Carro (próprio)';
            
            \Log::info('Criando viagem', [
                'meio_locomocao' => $meioLocomocao,
                'usa_carro_proprio' => $usaCarroProprio
            ]);
            ...
            if ($usaCarroProprio) {
                ...
                \Log::info('Salvando dados de carro próprio', $viagemCarroData);
                
                $viagemCarro = \App\Models\ViagemCarro::create($viagemCarroData);
                
                \Log::info('Viagem de carro próprio criada com sucesso', [
                    'viagem_id' => $viagem->pk_id_viagem,
                    'distancia_km' => $viagemCarroData['distancia_total_km'],
