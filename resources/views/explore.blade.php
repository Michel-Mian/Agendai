...
<div class="h-screen w-screen overflow-hidden bg-gray-100 flex flex-col">
    ...
    <!-- Mobile Panel Toggle melhorado -->
    <button id="mobile-panel-toggle" class="lg:hidden fixed bottom-6 right-6 w-16 h-16 bg-blue-600 text-white rounded-xl shadow-lg flex items-center justify-center hover:bg-blue-700 transition-all duration-300 z-50">
        <svg class="w-7 h-7" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/>
        </svg>
    </button>

    <!-- Mobile Panel Overlay melhorado -->
    <div id="mobile-panel-overlay" class="lg:hidden fixed inset-0 bg-black/60 backdrop-blur-sm z-40 hidden">
        <div id="mobile-panel" class="absolute bottom-0 left-0 right-0 bg-white rounded-t-xl p-6 max-h-[85vh] overflow-hidden transform translate-y-full transition-transform duration-300 shadow-xl">
            ...
            <div class="flex border-b border-gray-200 mb-6">
                <button class="mobile-day-tab px-4 py-2 font-medium border-b-2 border-blue-500 text-blue-600" data-day="1">Dia 1</button>
                <button class="mobile-day-tab px-4 py-2 font-medium border-b-2 border-transparent text-gray-500" data-day="2">Dia 2</button>
                <button class="mobile-day-tab px-4 py-2 font-medium border-b-2 border-transparent text-gray-500" data-day="3">Dia 3</button>
            </div>

            <!-- Mobile Itinerary Content -->
            <div id="mobile-itinerary-content" class="max-h-64 overflow-y-auto">
                <div class="flex flex-col items-center justify-center h-32 text-gray-400">
                    ...
                    <span class="text-sm text-center font-medium">Toque nos marcadores para adicionar</span>
                </div>
            </div>
        </div>
    </div>
...
<!-- Google Maps API -->
<script
  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDWLH0DB_w7iFWxaPJHOl69rSP6YT3sp80&libraries=places&callback=initMap"
  async
  defer>
</script>
@endsection
