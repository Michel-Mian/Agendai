...
<div class="flex min-h-[30vh] bg-gray-100">
    ...
    <div class="flex-1 flex flex-col">
        ...
        <h2 class="text-2xl font-bold mb-5 text-blue-700">Pesquisa de Hotéis</h2>
        <form id="hotel-search-form" class="flex flex-col gap-8 w-full">
            <div class="flex flex-col gap-6">
                <div class="flex flex-col gap-2">
                    <label for="hotel-query" class="text-lg text-blue-600 font-semibold mb-2 mt-1">Destino ou Nome do Hotel</label>
                    <input type="text" id="hotel-query" class="max-w-2xl px-5 py-3 border border-blue-200 rounded-xl shadow focus:outline-none focus:ring-2 focus:ring-blue-300 text-lg text-blue-700 placeholder-blue-400 transition" placeholder="Ex: Rio de Janeiro" required>
                </div>
                <div class="flex flex-col md:flex-row gap-6 items-end">
                    <div class="flex flex-col w-full md:w-1/3">
                        <label for="check-in-date" class="text-lg text-blue-600 mb-2 font-semibold">Check-in</label>
                        <input type="date" id="check-in-date" class="bg-blue-50 border border-blue-200 rounded-xl px-5 py-3 text-lg text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300 transition w-full" required>
                    </div>
                    <div class="flex flex-col w-full md:w-1/3">
                        <label for="check-out-date" class="text-lg text-blue-600 mb-2 font-semibold">Check-out</label>
                        <input type="date" id="check-out-date" class="bg-blue-50 border border-blue-200 rounded-xl px-5 py-3 text-lg text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300 transition w-full" required>
                    </div>
        ...
        <div id="results-summary" class="hidden mb-4">
            <div class="bg-blue-50 border border-blue-200 rounded-md p-3">
                <span id="results-count" class="text-blue-800 font-medium"></span>
            </div>
        </div>
        ...
        <div id="loading-indicator" class="hidden text-center mt-8">
            <div class="inline-flex items-center px-5 py-3 font-semibold leading-6 text-lg shadow rounded-xl text-blue-500 bg-blue-50 transition ease-in-out duration-150 border border-blue-200">
        ...
        <div id="pagination" class="flex justify-center mt-8">
            <button id="load-more" class="hidden bg-gradient-to-r from-blue-600 to-blue-500 text-white font-medium py-3 px-6 rounded-xl transition duration-200 flex items-center text-lg">
...
<div id="trip-selection-modal" class="fixed inset-0 bg-gray-900 bg-opacity-40 backdrop-blur-sm overflow-y-auto h-full w-full flex items-center justify-center z-50 hidden">
    <div class="relative bg-white rounded-lg shadow-xl p-4 w-full max-w-sm border border-gray-200">
        ...
        <div class="mb-3">
            ...
            <select id="trip-select" class="mt-1 block w-full pl-3 pr-10 py-2 text-lg border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 rounded-md">
            </select>
        </div>
        ...
        <div class="flex justify-end space-x-2">
            ...
            <button id="add-to-trip-confirm-btn" type="button" class="px-4 py-2 text-base font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                Adicionar
            </button>
        </div>
    </div>
