        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 max-w-7xl mx-auto">
            <div class="lg:col-span-1">
                <div class="flex items-center space-x-2 mb-4">
                    ...
                    <span class="text-lg md:text-xl font-bold">ExploreMap</span>
                </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm md:text-base text-gray-400">
                    <li><a href="/hospedagens" class="hover:text-emerald-400 transition-colors">Hospedagens</a></li>
                    <li><a href="/restaurantes" class="hover:text-emerald-400 transition-colors">Restaurantes</a></li>
                    <li><a href="/pontos-turisticos" class="hover:text-emerald-400 transition-colors">Pontos Turísticos</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm md:text-base text-gray-400">
                    <li><a href="/mapa" class="hover:text-emerald-400 transition-colors">Mapa Interativo</a></li>
                    <li><a href="/filtros" class="hover:text-emerald-400 transition-colors">Filtros Avançados</a></li>
                    <li><a href="/rotas" class="hover:text-emerald-400 transition-colors">Rotas e Direções</a></li>
