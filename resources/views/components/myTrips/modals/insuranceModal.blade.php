            ...
            <div id="insurance-search-form" class="">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <select id="insurance-destino" name="destino" class="w-full h-10 border-gray-600 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <input type="date" id="insurance-data-ida" name="data_ida" class="w-full h-10 border-gray-600 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label for="insurance-data-volta" class="block text-sm font-medium text-gray-700 mb-1">Data de Volta</label>
                        <input type="date" id="insurance-data-volta" name="data_volta" class="w-full h-10 border-gray-600 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
