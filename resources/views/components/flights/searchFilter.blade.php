        ...
        <form action="{{ route('flights.search') }}" method="GET" class="flex flex-col gap-6 w-full">
            <div class="flex flex-col md:flex-row md:items-end gap-6">
                ...
                <div class="flex flex-col w-full md:w-auto">
                    <label for="trip_type" class="text-xs text-black-600 mb-1 font-semibold">Tipo</label>
                    <select name="type_trip" id="type_trip" class="bg-black-50 border border-black-200 rounded-xl px-4 py-2 text-sm text-black-700 focus:outline-none focus:ring-2 focus:ring-black-300 transition">
                ...
                <!-- Classe -->
                <div class="flex flex-col w-full md:w-auto">
                    <label for="class" class="text-xs text-black-600 mb-1 font-semibold">Classe</label>
                    <select name="class" id="class" class="bg-black-50 border border-black-200 rounded-xl px-4 py-2 text-sm text-black-700 focus:outline-none focus:ring-2 focus:ring-black-300 transition">
                        <option value="">Qualquer</option>
                ...
                <!-- Ordenar -->
                <div class="flex flex-col w-full md:w-auto">
                    <label for="sort_by" class="text-xs text-black-600 mb-1 font-semibold">Ordenar por</label>
                    <select name="sort_by" id="sort_by" class="bg-black-50 border border-black-200 rounded-xl px-4 py-2 text-sm text-black-700 focus:outline-none focus:ring-2 focus:ring-black-300 transition">
                ...
                <!-- Filtro de preço -->
                <div class="flex flex-col w-full md:w-auto">
                    <label for="price" class="text-xs text-black-600 mb-1 font-semibold">Preço máximo (R$)</label>
                    <input type="number" min="0" step="50" name="price" id="price" placeholder="Ex: 2000" class="bg-black-50 border border-black-200 rounded-xl px-4 py-2 text-sm text-black-700 focus:outline-none focus:ring-2 focus:ring-black-300 transition w-full md:w-32">
                </div>
            </div>
            <!-- Origem e destino -->
            <div class="flex flex-1 bg-black-50 rounded-xl border border-black-200 shadow-inner">
                <!-- Origem -->
                <div class="flex items-center px-4 py-3 gap-2 w-1/2 border-r border-black-200 relative">
                    <i class="fa-regular fa-dot-circle text-black-600"></i>
                    <input 
                        type="text" 
                        name="dep_iata" 
                        id="dep_iata"
                        placeholder="Origem (IATA)"
                        class="bg-transparent border-0 focus:outline-none text-base text-black-700 placeholder-black-400 w-full airport-autocomplete"
                        autocomplete="off"
                    >
                ...
                <div class="flex items-center justify-center px-2 py-1">
                    <i class="fa-solid fa-right-left text-black-400 text-lg"></i>
                </div>
                <!-- Destino -->
                <div class="flex items-center px-4 py-3 gap-2 w-1/2 relative">
                    <i class="fa-solid fa-location-dot text-black-600"></i>
                    <input 
                        type="text" 
                        name="arr_iata" 
                        id="arr_iata"
            ...
            <div class="flex flex-col md:flex-row gap-6 mt-2">
                <!-- Datas -->
                <div class="flex flex-1 flex-col xs:flex-row bg-black-50 rounded-xl border border-black-200 overflow-hidden shadow-inner">
                    <div class="flex items-center px-4 py-3 gap-2 w-full xs:w-1/2 border-b xs:border-b-0 xs:border-r border-black-200">

                        <input 
                            type="date" 
                            name="date_departure" 
                            id="date_departure"
                            class="bg-transparent border-0 focus:outline-none text-base text-black-700 w-full"
                        >
                    </div>
