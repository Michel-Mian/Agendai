...
<div class="w-full px-2 sm:px-4 py-6 bg-gray-50">
    <div class="flex flex-col sm:flex-row bg-blue-50 rounded-lg shadow mb-6 max-w-xl mx-auto border border-blue-100">
        ...
        <button type="button" class="flex-1 px-4 sm:px-6 py-2 bg-transparent text-blue-700 rounded-lg font-semibold transition cursor-pointer hover:bg-gray-100 hover:text-blue-900" id="btnPreferences">
            Preferências
        </button>
    </div>
    <div class="bg-white/90 shadow-xl rounded-2xl p-4 sm:p-8 max-w-xl mx-auto border border-blue-100" id="cardProfile">
        @if ($errors->any())
            <div class="mb-4">
            ...
            <div class="flex flex-col items-center mb-8">
                <div class="relative group">
                    <img 
                        ...
                        alt="Foto de Perfil"
                        class="w-28 h-28 sm:w-36 sm:h-36 rounded-full object-cover shadow-lg transition group-hover:brightness-75"
                ...
                <span class="text-gray-500 text-sm mt-3 text-center">Clique no ícone para alterar a foto</span>
            </div>

            <!-- Campos do Perfil -->
            <div class="mb-5">
                <label for="name" class="block text-base sm:text-lg font-semibold text-blue-900 mb-1">Nome</label>
                <div class="relative">
                    <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-blue-400">
                        <i class="fa-solid fa-user" style="color:#55aef3;"></i>
                    </span>
                    <input type="text" id="name" name="name" value="{{ $user->name ?? '' }}" class="pl-10 pr-4 py-2 block w-full border border-blue-200 rounded-lg shadow-sm focus:ring-blue-500 text-blue-900 placeholder-blue-300 transition text-sm sm:text-base" placeholder="Seu nome">
                </div>
            </div>
            <div class="mb-5">
                <label for="email" class="block text-base sm:text-lg font-semibold text-blue-900 mb-1">Email</label>
                <div class="relative">
                    <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-blue-400">
                        <i class="fa-solid fa-envelope" style="color:#55aef3;"></i>
                    </span>
                    <input type="email" id="email" name="email" value="{{ $user->email ?? '' }}" class="pl-10 pr-4 py-2 block w-full border border-blue-200 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 text-blue-900 placeholder-blue-300 transition text-sm sm:text-base" placeholder="Seu email">
                </div>
            </div>
    ...
    <div class="bg-white/90 shadow-xl rounded-2xl p-4 sm:p-8 max-w-xl mx-auto border border-blue-100 hidden" id="cardPreferences">
        <form action="{{ route('user.updatePreferences', $user->id) }}" method="POST" id="preferencesForm">
            ...
            <div class="mb-5">
                <label for="language" class="block text-base sm:text-lg font-semibold text-blue-900 mb-1">Idioma</label>
                <select id="language" name="language" class="block w-full border border-blue-200 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 text-blue-900 placeholder-blue-300 transition py-2 px-3 text-sm sm:text-base">
            ...
            <div class="mb-5">
                <label for="theme" class="block text-base sm:text-lg font-semibold text-blue-900 mb-1">Tema</label>
                <select id="theme" name="theme" class="block w-full border border-blue-200 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 text-blue-900 placeholder-blue-300 transition py-2 px-3 text-sm sm:text-base">
            ...
            <div class="mb-5">
                <label for="currency" class="block text-base sm:text-lg font-semibold text-blue-900 mb-1">Moeda</label>
                <select id="currency" name="currency" class="block w-full border border-blue-200 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 text-blue-900 placeholder-blue-300 transition py-2 px-3 text-sm sm:text-base">
