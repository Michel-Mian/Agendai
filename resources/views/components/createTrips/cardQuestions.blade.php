<div class="bg-white rounded-lg shadow-md mb-6 mb-10">
    <div class="p-6">
        <div class="flex items-center mb-2">
            <h2 class="text-2xl font-bold mr-3">Informações iniciais</h2>
        </div>
        <p class="text-gray-900 font-bold mb-4">Qual seu destino?</p>
