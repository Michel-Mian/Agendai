...
// Declarar locationInput no escopo global
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const placeTypes = [
        ...
        { id: 'bicycle_store', name: 'Loja de Bicicletas', category: 'Compras & Serviços' },
        ...
        { id: 'car_repair', name: 'Serviços Automotivos', category: 'Serviços' }, // Combined
        { id: 'casino', name: 'Cassino', category: 'Entretenimento' },
        { id: 'cemetery', name: 'Cemitério', category: 'Outros' },
        { id: 'place_of_worship', name: 'Locais de Culto', category: 'Religião' }, // Combined
        ...
        { id: 'health', name: 'Saúde', category: 'Serviços' }, // Combined Dentist, Doctor, etc.
        ...
        { id: 'gas_station', name: 'Posto de Combustível', category: 'Serviços' },
        ...
        { id: 'laundry', name: 'Lavanderia', category: 'Serviços & Compras' },
        ...
        { id: 'lodging', name: 'Acomodações', category: 'Hospedagem' }, // More general term
        ...
        { id: 'pharmacy', name: 'Farmácia', category: 'Saúde & Compras' },
        ...
        { id: 'taxi_stand', name: 'Ponto de Táxi', category: 'Transporte' },       { id: 'tourist_attraction', name: 'Atrações', category: 'Turismo & Cultura' }, // Combined
